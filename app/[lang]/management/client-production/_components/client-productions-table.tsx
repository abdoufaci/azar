...
import ProductionDetails from "../../production/_components/production-details";
...
function ClientProductionsTable({
  orderStages,
  employees,
  columns,
  onClick,
      ...
      <Table className="w-full relative">
        ...
        <TableBody className="bg-white">
          {isFetchingNextPage || isFetchingPreviousPage || tanstackIsPending ? (
            <>
              <ClientProductionsTable.Skeleton />
              <ClientProductionsTable.Skeleton />
              <ClientProductionsTable.Skeleton />
              <ClientProductionsTable.Skeleton />
              <ClientProductionsTable.Skeleton />
...
export default ClientProductionsTable;

ClientProductionsTable.Skeleton = function SkeletonClientProductionsTable() {
  return (
